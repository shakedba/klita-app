...
Design a clear, compelling value proposition using a 6-part JTBD template. An alternative to Strategyzer's Value Proposition Canvas that starts with the customer.
...
Apply **value-proposition** skill to produce the 6-part template:
...
- Use a Value Curve (Blue Ocean Strategy) to visually compare your offering against competitors
